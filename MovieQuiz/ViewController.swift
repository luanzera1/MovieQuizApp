...
class ViewController: UIViewController {
    ...
    func playBackgroundMusic() {
        //let musicURL = Bundle.main.url(forResource: "MarchaImperial", withExtension: "mp3")! // Via direto do device
        let musicURL = URL(string: "https://goo.gl/HJwvyZ")! // Via Streaming
